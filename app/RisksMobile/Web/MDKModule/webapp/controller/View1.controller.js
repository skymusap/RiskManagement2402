sap.ui.define([
	...
	return Controller.extend("RiskManagement2402_RisksMobile.controller.View1", {
        setUrl: function () {
            ...
            var url = sap.ui.require.toUrl("RiskManagement2402_RisksMobile/mdkindex.html?" + queryString);
